...
namespace UIKit
{
    ...
    public class UIKitRangeSlider : UIKitSelectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        [Serializable]
        ...
        public void SetLowValue(float input, bool sendCallback)
        {
            SetLow(input, sendCallback);
        }
        ...
        public void SetHighValue(float input, bool sendCallback)
        {
            SetHigh(input, sendCallback);
        }
