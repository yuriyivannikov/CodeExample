...
{
    /// <summary>
    /// Является копией класса UnityEditor.UI.Scrollbar с небольшими правками
    /// https://bitbucket.org/Unity-Technologies/ui/src/f0c70f707cf09f959ad417049cb070f8e296ffe2/UnityEngine.UI/UI/Core/Scrollbar.cs?at=5.5&fileviewer=file-view-default
    /// </summary>

    //[AddComponentMenu("UI/Scrollbar", 34)]
    [RequireComponent(typeof(RectTransform))]
    public class UIKitScrollbar : UIKitSelectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        public float size { get { return m_Size; } set { if (UIKitSetPropertyUtility.SetStruct(ref m_Size, Mathf.Clamp01(value))) UpdateVisuals(); } }
        ...
        public int numberOfSteps { get { return m_NumberOfSteps; } set { if (UIKitSetPropertyUtility.SetStruct(ref m_NumberOfSteps, value)) { Set(m_Value); UpdateVisuals(); } } }
