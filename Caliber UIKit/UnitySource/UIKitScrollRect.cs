...
{
    /// <summary>
    /// Является копией класса UnityEngine.UI.ScrollRect с небольшими правками
    /// https://bitbucket.org/Unity-Technologies/ui/src/f0c70f707cf09f959ad417049cb070f8e296ffe2/UnityEngine.UI/UI/Core/ScrollRect.cs?at=5.5&fileviewer=file-view-default
    /// </summary>
    ...
    public class UIKitScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        [SerializeField]
        private UIKitScrollbar m_HorizontalScrollbar;
        public UIKitScrollbar horizontalScrollbar
        {
            get
            {
        ...
        [SerializeField]
        private UIKitScrollbar m_VerticalScrollbar;
        public UIKitScrollbar verticalScrollbar
        {
            get
            {
        ...
        private static void UpdateOneScrollbarVisibility(bool xScrollingNeeded, bool xAxisEnabled, ScrollbarVisibility scrollbarVisibility, UIKitScrollbar scrollbar)
        {
            if (scrollbar)
            {
