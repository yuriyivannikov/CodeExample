...
{
    // <summary>
    /// Является копией класса UnityEditor.UI.ScrollbarEditor с небольшими правками
    /// https://bitbucket.org/Unity-Technologies/ui/src/f0c70f707cf09f959ad417049cb070f8e296ffe2/UnityEditor.UI/UI/ScrollbarEditor.cs?at=5.5&fileviewer=file-view-default
    /// </summary>

    [CustomEditor(typeof(UIKitScrollbar), true)]
    [CanEditMultipleObjects]
    public class UIKitScrollbarEditor : UIKitSelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HandleRect.objectReferenceValue != null)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    UIKitScrollbar.Direction direction = (UIKitScrollbar.Direction)m_Direction.enumValueIndex;
                    foreach (var obj in serializedObject.targetObjects)
                    {
                        UIKitScrollbar scrollbar = obj as UIKitScrollbar;
                ...
                {
                    UIKitScrollbar scrollbar = obj as UIKitScrollbar;
                    UIKitScrollbar.Direction dir = scrollbar.direction;
                    if (dir == UIKitScrollbar.Direction.LeftToRight || dir == UIKitScrollbar.Direction.RightToLeft)
                        warning = (scrollbar.navigation.mode != UIKitNavigation.Mode.Automatic && (scrollbar.FindSelectableOnLeft() != null || scrollbar.FindSelectableOnRight() != null));
                    else
                        warning = (scrollbar.navigation.mode != UIKitNavigation.Mode.Automatic && (scrollbar.FindSelectableOnDown() != null || scrollbar.FindSelectableOnUp() != null));
                }
