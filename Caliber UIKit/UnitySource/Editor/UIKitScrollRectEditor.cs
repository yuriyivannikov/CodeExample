...
{
    // <summary>
    /// Является копией класса UnityEditor.UI.ScrollRect с небольшими правками
    /// https://bitbucket.org/Unity-Technologies/ui/src/f0c70f707cf09f959ad417049cb070f8e296ffe2/UnityEditor.UI/UI/ScrollRectEditor.cs?at=5.5&fileviewer=file-view-default
    /// </summary>

    [CustomEditor(typeof(UIKitScrollRect), true)]
    [CanEditMultipleObjects]
    public class UIKitScrollRectEditor : Editor
    {
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)UIKitScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((UIKitScrollRect)target).transform;
                ...
                if (m_HorizontalScrollbar.objectReferenceValue == null || ((UIKitScrollbar)m_HorizontalScrollbar.objectReferenceValue).transform.parent != transform)
                    m_HScrollbarIsNotChild = true;
                if (m_VerticalScrollbar.objectReferenceValue == null || ((UIKitScrollbar)m_VerticalScrollbar.objectReferenceValue).transform.parent != transform)
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((UIKitScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == UIKitScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((UIKitScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == UIKitScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
